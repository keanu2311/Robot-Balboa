...
//Pour observer valeur reprises de matlab du travail state space 
const int32_t K1 = 740.8 ;
const int32_t K2_1 = -593.2 ;
const int32_t K2_2 = -1803.6 ;
const int32_t K2_3 = -392.9 ;
const int32_t K3 = 3969.7 ;
const int32_t L1 = 10.7 ;
const int32_t L2 = 2055.8 ;
const int32_t L3 = 392.9 ;

const int32_t K_pos1 = -1900.7 ;
const int32_t K_pos2 = -320.3 ;
const int32_t K_pos3 = -80.7 ;
const int32_t K_pos4 = -105.5 ;
const int32_t N_pos = -71.7 ;
//Pour StateSpace speed sans AI
const int32_t K_speed1 = -900.9 ;
const int32_t K_speed2 = -80.1 ;
const int32_t K_speed3 = -70.3 ;
const int32_t N_speed = -115.2 ;
...
const uint8_t filter_time_MS = 1000; 
...
extern int32_t angle_a; // unit milli radian
